 ...
 */
class Oro_Orderstat_Model_Indexer_Vendorsku extends Mage_Index_Model_Indexer_Abstract
{
    /**
     * @var array
     */
    ...
    {
        $this->_init('orderstat/indexer_vendorsku');
    }
    ...
    protected function _registerCatalogProductSaveEvent(Mage_Index_Model_Event $event)
    {
        ...
        $reindex = $product->getForceReindexRequired()
            || $product->dataHasChangedFor(Oro_Orderstat_Helper_Data::ATTRIBUTE_VENDOR_SKU);
