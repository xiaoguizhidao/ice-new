 ...
 */
class Oro_Delmar_Model_Resource_Indexer_Vendorsku extends Mage_Catalog_Model_Resource_Product_Indexer_Abstract
{
    /**
     * Define main table
     *
    ...
    {
        $this->_init('delmar/index', 'product_id');
    }
    ...
    public function catalogProductSave(Mage_Index_Model_Event $event)
    {
        ...
        $this->saveIndex(array(array(
            ...
            'vendor_sku' => $event->getDataObject()->getData(Oro_Delmar_Helper_Data::ATTRIBUTE_VENDOR_SKU)
        )));
    ...
    public function reindexAll()
    {
        ...
        $attribute = Mage::getSingleton('eav/config')
            ->getAttribute('catalog_product', Oro_Delmar_Helper_Data::ATTRIBUTE_VENDOR_SKU);
