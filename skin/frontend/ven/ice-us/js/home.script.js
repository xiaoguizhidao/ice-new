jQuery(function () {
    initScrollGallery();
//    InitSlideDrop();
//    initAutoScalingNav({menuId: "nav", liHovering: false, flexible: true, equalLinks: false, sideClasses: true, spacing: 1});
//    initAutoScalingNav({menuId: "navbar", sideClasses: true, minPaddings: 10});
    jQuery(".Enter-1").mouseenter(function () {
        jQuery("#Splash1").fadeIn("slow");
        jQuery("#Splash2").fadeOut("fast");
        jQuery("#Splash3").fadeOut("fast");
        jQuery("#Splash4").fadeOut("fast")
    });
    jQuery(".Enter-2").mouseenter(function () {
        jQuery("#Splash2").fadeIn("slow");
        jQuery("#Splash1").fadeOut("fast");
        jQuery("#Splash3").fadeOut("fast");
        jQuery("#Splash4").fadeOut("fast")
    });
    jQuery(".Enter-3").mouseenter(function () {
        jQuery("#Splash3").fadeIn("slow");
        jQuery("#Splash1").fadeOut("fast");
        jQuery("#Splash2").fadeOut("fast");
        jQuery("#Splash4").fadeOut("fast")
    });
    jQuery(".Enter-4").mouseenter(function () {
        jQuery("#Splash4").fadeIn("slow");
        jQuery("#Splash1").fadeOut("fast");
        jQuery("#Splash2").fadeOut("fast");
        jQuery("#Splash3").fadeOut("fast")
    });
    ...
    setInterval(function () {
        if (a < 4) {
            a++;
            jQuery("#slideshow > div:first").fadeOut("slow").next().fadeIn("slow").end().appendTo("#slideshow")
        }
    }, 4000);
    jQuery("#slideshowv > li:first").show();
    setInterval(function () {
        jQuery("#slideshowv > li:first").fadeOut(1000).next().fadeIn(2000).end().appendTo("#slideshowv")
    }, 4000)
});
